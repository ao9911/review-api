...
const (
	...
	Review_ListReviewsByStoreId_FullMethodName = "/api.review.v1.Review/ListReviewsByStoreId"
)
...
type ReviewClient interface {
	...
	// 审核评价
	AuditReview(ctx context.Context, in *AuditReviewRequest, opts ...grpc.CallOption) (*AuditReviewResponse, error)
	// 回复评价
	ReplyReview(ctx context.Context, in *ReplyReviewRequest, opts ...grpc.CallOption) (*ReplyReviewResponse, error)
	// 申诉评价
	AppealReview(ctx context.Context, in *AppealReviewRequest, opts ...grpc.CallOption) (*AppealReviewResponse, error)
	// 审核申诉
	AuditAppeal(ctx context.Context, in *AuditAppealRequest, opts ...grpc.CallOption) (*AuditAppealResponse, error)
	// 根据用户ID列出评价
	ListReviewsByUserId(ctx context.Context, in *ListReviewsByUserIdRequest, opts ...grpc.CallOption) (*ListReviewsByUserIdResponse, error)
	// 根据商家ID列出评价
	ListReviewsByStoreId(ctx context.Context, in *ListReviewsByStoreIdRequest, opts ...grpc.CallOption) (*ListReviewsByStoreIdResponse, error)
}
...
func (c *reviewClient) AuditReview(ctx context.Context, in *AuditReviewRequest, opts ...grpc.CallOption) (*AuditReviewResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuditReviewResponse)
...
func (c *reviewClient) ReplyReview(ctx context.Context, in *ReplyReviewRequest, opts ...grpc.CallOption) (*ReplyReviewResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *reviewClient) AppealReview(ctx context.Context, in *AppealReviewRequest, opts ...grpc.CallOption) (*AppealReviewResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AppealReviewResponse)
...
func (c *reviewClient) AuditAppeal(ctx context.Context, in *AuditAppealRequest, opts ...grpc.CallOption) (*AuditAppealResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuditAppealResponse)
...
func (c *reviewClient) ListReviewsByUserId(ctx context.Context, in *ListReviewsByUserIdRequest, opts ...grpc.CallOption) (*ListReviewsByUserIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListReviewsByUserIdResponse)
	err := c.cc.Invoke(ctx, Review_ListReviewsByUserId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reviewClient) ListReviewsByStoreId(ctx context.Context, in *ListReviewsByStoreIdRequest, opts ...grpc.CallOption) (*ListReviewsByStoreIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListReviewsByStoreIdResponse)
	err := c.cc.Invoke(ctx, Review_ListReviewsByStoreId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReviewServer) AuditReview(context.Context, *AuditReviewRequest) (*AuditReviewResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AuditReview not implemented")
}
func (UnimplementedReviewServer) ReplyReview(context.Context, *ReplyReviewRequest) (*ReplyReviewResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReplyReview not implemented")
}
func (UnimplementedReviewServer) AppealReview(context.Context, *AppealReviewRequest) (*AppealReviewResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AppealReview not implemented")
}
func (UnimplementedReviewServer) AuditAppeal(context.Context, *AuditAppealRequest) (*AuditAppealResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AuditAppeal not implemented")
}
func (UnimplementedReviewServer) ListReviewsByUserId(context.Context, *ListReviewsByUserIdRequest) (*ListReviewsByUserIdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListReviewsByUserId not implemented")
}
func (UnimplementedReviewServer) ListReviewsByStoreId(context.Context, *ListReviewsByStoreIdRequest) (*ListReviewsByStoreIdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListReviewsByStoreId not implemented")
}
...
func _Review_ListReviewsByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListReviewsByUserIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServer).ListReviewsByUserId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Review_ListReviewsByUserId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).ListReviewsByUserId(ctx, req.(*ListReviewsByUserIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Review_ListReviewsByStoreId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListReviewsByStoreIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServer).ListReviewsByStoreId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Review_ListReviewsByStoreId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).ListReviewsByStoreId(ctx, req.(*ListReviewsByStoreIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Review_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListReviewsByStoreId",
			Handler:    _Review_ListReviewsByStoreId_Handler,
		},
	},
